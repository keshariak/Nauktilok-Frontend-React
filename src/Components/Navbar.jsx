 ...
 useEffect(()=>{
  ...
  return (
    <div className='w-full h-[10vh] border-b-2 flex items-center justify-center '>
      ...
      <div ref={sidebarref} className={`md:hidden block fixed w-[80%] transition-all duration-500  h-[100vh] top-0  bg-white ${sidbarOpen ? "left-0" : "left-[-100%]"}`}> 
...
<div className='w-full h-12  flex items-center pl-3'> <h1 className='font-semibold text-gray-700 hover:text-[#008BDC]'>Edit Resume</h1></div>
...
<div className='w-full h-12  flex items-center pl-3'>
   <h1 className='font-semibold text-gray-700 hover:text-[#008BDC]'>  <button onClick={logoutHandler} >LogOut</button></h1>
      ...
      <Link to={"/home"}  className='ml-3 md:block hidden'>Internships</Link>
      <Link to={"/home"}  className='ml-3 md:block hidden'>Jobs</Link>
      ...
      className='relative w-fit px-5 h-[72px]  flex items-center hover:bg-blue-100'>
